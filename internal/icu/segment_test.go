...
func TestBreaks(t *testing.T) {
	for _, tc := range []struct {
		...
		{Words, "中华人民共和国今天天气很好", "中华|人民|共和国|今天|天气|很好"},
		{Words, "私は日本語のテキストを書きます", "私|は|日本語|の|テキスト|を|書き|ます"},
		{Words, "ﾃｷｽﾄです", "ﾃｷｽﾄ|です"},
		{Words, "ガラスを買う", "ガラス|を|買う"},
		{Words, "ภาษาไทยเป็นภาษาที่สวยงาม", "ภาษา|ไทย|เป็น|ภาษา|ที่|สวยงาม"},
		{Words, "ພາສາລາວເປັນພາສາທີ່ສວຍງາມ", "ພາສາ|ລາວ|ເປັນ|ພາສາ|ທີ່|ສວຍງາມ"},
		{Words, "ភាសាខ្មែរជាភាសាដ៏ស្រស់ស្អាត", "ភាសាខ្មែរ|ជា|ភាសា|ដ៏|ស្រស់|ស្អាត"},
		{Words, "မြန်မာဘာသာစကားသည်လှပသည်", "မြန်မာဘာသာ|စကား|သည်|လှပ|သည်"},
